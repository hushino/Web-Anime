...
//en caso de no usar angular u otro api activar todo
require('express-helpers')(app); // nesesario para que ejs funcione ejemplo: link_to
// view engine setup
//app.disable('etag');
...
app.engine('.ejs', ejs); //eliminar si es nesesario junto a __express
